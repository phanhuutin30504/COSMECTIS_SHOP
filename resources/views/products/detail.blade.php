            ...
            <div class="row">
                ...
                <div class="col-md-9 product-detail">
                    <div class="row product-info">
                        <div class="col-md-6">
                            <img data-zoom-image="{{ asset($product->featured_image) }}"
                            ...
                            <div class="product-detail-carousel-slider">
                                <div class="owl-carousel owl-theme">
                                    ...
                                    @foreach ($product->images as $image)
                                        <div class="item thumbnail">
                                            <img src="{{ asset('upload/' . $image->image_path) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <form action="{{ route('cart.add') }}" method="POST">
                                    ...
                                    <input type="number" class="product-quantity form-control" name="qty"
                                        value="1" min="1"> <!-- Số lượng có thể thay đổi -->
                            ...
                            <div role="tabpanel">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="product-comment">
                                        <form class="form-comment" action="{{ route('comment.send') }}" method="POST"
                                            role="form">
                                            @csrf
                                            <label>Đánh giá của bạn</label>
                                            <div class="form-group">
                                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                                <input class="rating-input" name="star" type="text" title=""
                                                    value="{{ $product->star }}" />
                                        ...
                                        @foreach ($product->comments as $comments)
                                            <div class="comment-list">
                                                ...
                                                <input class="answered-rating-input" name="rating" type="text"
                                                    title="" value="{{ $comments->star }}" readonly />
                                        ...
                                        <div class="product-container">
                                            <div class="image">
                                                <img class="img-responsive"
                                                    src="{{ asset($relatedProduct->featured_image) }}" alt="">
                                            </div>
                                            <div class="product-meta">
                                                <h5 class="name">
                                                    <a class="product-name" href="{{ route('product.detail', $relatedProduct->id) }}"
                                                        title="{{ $relatedProduct->name }}">{{ $relatedProduct->name }}</a>
                                                </h5>
                                                <div class="product-item-price">
                                                    <span
                                                        class="product-item-discount">{{ number_format($relatedProduct->price, '0', '', '.') }}đ</span>
                                                </div>
                                            </div>
                                            <div class="button-product-action clearfix">
                                                <div class="cart icon">
                                                    <form action="{{ route('cart.add') }}" method="POST">
                                                        ...
                                                        <input type="hidden" class="product-quantity form-control"
                                                            value="1" min="1">
                                                        <button class="btn btn-outline-inverse buy" title="Thêm vào giỏ">
